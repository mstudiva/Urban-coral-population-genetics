...
# Get the sample information for your qPCR plates (if you use a template)
  SampleName<-read.csv("Metadata/Sample_Plates.csv") # Plate, Sample_Plate (including .csv), and corresponding sample name (from qPCR plate template)
...
# Get treatment information
  Urban<-left_join(Urban, Metadata, by="Fragment")

...
```{bash, countmapped}
echo '#!/bin/bash' >mappedZooxReads.sh
echo readCounts.sh -e zoox -o Zoox >>mappedZooxReads.sh
sbatch --mem=200GB --mail-type=ALL --mail-user=studivanms@gmail.com mappedZooxReads.sh
```
...
launcher_creator.py -j s2b.sh -n s2b -t 6:00:00 -N 5 -e studivanms@gmail.com -q shortq7
sbatch s2b.slurm
```
...
echo readCounts.sh -e host -o Host >>mappedReads.sh
...
launcher_creator.py -j s2b.sh -n s2b -q shortq7 -t 06:00:00 -e studivanms@gmail.com

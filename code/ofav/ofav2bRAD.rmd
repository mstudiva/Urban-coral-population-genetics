...
- [2bRAD processing](https://mstudiva.github.io/Urban-coral-population-genetics/code/2bRADstart.Rmd)
...
cloneBams = read.csv("ofavMetadata.csv") # list of bam files

cloneMa = as.matrix(read.table("ANGSD/ofavClones.ibsMat")) # reads in IBS matrix produced by ANGSD 
...
# Making points at the leaves to place symbols for regionulations
point = as.vector(NA)
for(i in 1:nrow(cloneDData$segments)) {
...
```
![](../../data/ofav/clones/cloneDend.png)
<br>

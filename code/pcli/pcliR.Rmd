---
title: "*Pseudodiplora clivosa* population genetics"
...
knit: (function(input, ...) {
    rmarkdown::render(
      input,
      output_file = '../../data/pcli/index.html',
      envir = globalenv()
    )
  })
---
...
```{r, pcangsd}
cov = read.table("../../data/pcli/pcangsd/pcliPcangsd.cov") %>% as.matrix()

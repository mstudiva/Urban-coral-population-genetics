...
cloneBams = read.csv("dlabMetadata.csv") # list of bam files

cloneMa = as.matrix(read.table("ANGSD/dlabClones.ibsMat")) # reads in IBS matrix produced by ANGSD 
...
```{bash, ngsadmix}
ngsAdmixLauncher.py -f dlabNoClones.beagle.gz --maxK 16 -r 50 -n dlab --launcher -e studivanms@gmail.com
...
# -------------------------
data_file <- "dlabNgsAdmixLogfile_formatted"  # replace with your file

---
title: "*Pseudodiplora strigosa* population genetics"
...
knit: (function(input, ...) {
    rmarkdown::render(
      input,
      output_file = '../../data/pstr/index.html',
      envir = globalenv()
    )
  })
---
...
- [*Pseudodiplora strigosa*](https://mstudiva.github.io/Urban-coral-population-genetics/code/pstr)
...
```{r, pcangsd}
cov = read.table("../../data/pstr/pcangsd/pstrPcangsd.cov") %>% as.matrix()

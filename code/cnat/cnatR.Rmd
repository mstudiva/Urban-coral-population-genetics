---
title: "*Colpophyllia natans* population genetics"
...
knit: (function(input, ...) {
    rmarkdown::render(
      input,
      output_file = '../../data/cnat/index.html',
      envir = globalenv()
    )
  })
---
...
```{r, pcangsd}
cov = read.table("../../data/cnat/pcangsd/cnatPcangsd.cov") %>% as.matrix()

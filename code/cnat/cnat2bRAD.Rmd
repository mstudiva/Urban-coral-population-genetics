...
cloneBams = read.csv("cnatMetadata.csv") # list of bam files

cloneMa = as.matrix(read.table("ANGSD/cnatClones.ibsMat")) # reads in IBS matrix produced by ANGSD 
...
```{bash, ngsadmix}
ngsAdmixLauncher.py -f cnatNoClones.beagle.gz --maxK 16 -r 50 -n cnat --launcher -e studivanms@gmail.com
...
# -------------------------
data_file <- "cnatNgsAdmixLogfile_formatted"  # replace with your file

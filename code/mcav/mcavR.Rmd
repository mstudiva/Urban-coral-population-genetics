---
title: "*Montastraea cavernosa* population genetics"
...
knit: (function(input, ...) {
    rmarkdown::render(
      input,
      output_file = '../../data/mcav/index.html',
      envir = globalenv()
    )
  })
---
...
bams = read.csv("../../data/mcav/mcavMetadata.csv")[-c(3, 19, 28, 30, 49, 51, 68, 70, 71, 73, 74, 75, 79, 89, 90),] # list of bams files and their populations (tech reps removed)

ma = as.matrix(read.table("../../data/mcav/ANGSD/mcavNoClones.ibsMat")) # reads in IBS matrix produced by ANGSD
...
DendPoints$site = factor(DendPoints$site,levels(DendPoints$site)[c(5, 13, 6, 4, 14, 10, 3, 12, 1, 7, 9, 8, 2, 15, 11)])
...
ggsave("../../figures/mcav/Dend.pdf", plot = Dend, height = 8, width = 24, units = "in", dpi = 300)
ggsave("../../figures/mcav/Dend.png", plot = Dend, height = 8, width = 24, units = "in", dpi = 300)
```
![](../../figures/mcav/Dend.png)
...
```{r, pcangsd}
cov = read.table("../../data/mcav/pcangsd/mcavPcangsd.cov") %>% as.matrix()

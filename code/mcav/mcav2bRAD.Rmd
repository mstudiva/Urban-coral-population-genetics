...
cloneMa = as.matrix(read.table("../../data/mcav/mcavClones.ibsMat")) # reads in IBS matrix produced by ANGSD 
...
# -------------------------
data_file <- "../../data/mcav/mcavNgsAdmixLogfile_formatted"  # replace with your file
